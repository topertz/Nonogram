...
namespace Grafilogika_alkalmazas_keszitese
{
    public class NonogramRender
    {
        ...
        private static readonly Color[] NonogramPalette = {
        ...
        public Color[] GetTwoRandomColors()
        {
            ...
            int firstIndex = rnd.Next(NonogramPalette.Length);
            int secondIndex;
            do
            {
                secondIndex = rnd.Next(NonogramPalette.Length);
            } while (secondIndex == firstIndex);

            return new Color[] { NonogramPalette[firstIndex], NonogramPalette[secondIndex] };
        }
