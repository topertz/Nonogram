    ...
    public class GameTimerManager
    {
        ...
        private void SetTimeByDifficulty()
        {
            if (grid.isColor) // Színes mód
            {
                ...
                {
                    case 0: remainingSeconds = 6 * 60; break;   // Könnyű
                    case 1: remainingSeconds = 18 * 60; break;   // Közepes
                    case 2: remainingSeconds = 35 * 60; break;   // Nehéz
        ...
        public void DifficultyOrModeChanged()
        {
            ...
            hintEngine.SetHintEngine(form, grid.row, grid.col, grid.isColor, grid.solutionBW, grid.solutionColorRGB, grid.userColorRGB, grid.userXMark);
