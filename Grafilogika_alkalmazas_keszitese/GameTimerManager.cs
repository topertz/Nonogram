...
namespace Grafilogika_alkalmazas_keszitese
{
    public class GameTimerManager
    {
        ...
        public GameTimerManager(Nonogram f, NonogramGrid g, NonogramRender r, UndoRedoManager u)
        {
            this.form = f;
            this.grid = g;
            this.render = r;
        ...
        public void BtnTips_Click(object sender, EventArgs e)
        {
            ...
            tips.AppendLine("X-ek színes módban is használhatók a kizáráshoz, " +
        ...
        public void DifficultyOrModeChanged()
        {
            ...
            switch (form.cmbDifficulty.SelectedIndex)
            {
                ...
                case 2:
                    width = height = 15;
                    targetPixels = grid.isColor ? 90 : 100;
                    maxAttempts = 2500;
                    form.chkShowX.Visible = false;
                    form.btnSelectImage.Visible = false;
                    break;
