    ...
    public partial class Nonogram : Form
    {
        ...
        public Nonogram()
        {
            ...
            toolTip = new ToolTip
            {
                ...
                InitialDelay = 400,     // Várakozás a megjelenés elõtt, ha rátartod az egeret (0.4 mp)
                ReshowDelay = 200,      // Várakozás, ha egyik elemrõl a másikra mozgatod az egeret (0.2 mp)
        ...
        private void InitializeCustomComponents()
        {
            ...
            groupModes.Paint += (s, e) =>
            {
                ...
                // Rectangle definiálása a kerethez
            ...
            rbNumberEntryMode.Text = "Számbeíró mód";
            ...
            rbImgBlackWhiteMode.Text = "Fekete-fehér képbeolvasó mód";
            rbImgBlackWhiteMode.Location = new Point(10, 40); // a Színes mód fölé
            ...
            rbImgColorMode.Text = "Színes képbeolvasó mód";
            ...
            cmbDifficulty.Items.AddRange(new string[] { "Könnyû", "Közepes", "Nehéz" });
            ...
            lblWrongCellClicks.Text = $"Helytelen kattintások száma: {grid.wrongCellClicks}";
            ...
            lblWrongColorClicks.Text = $"Helytelen színek száma: {grid.wrongColorClicks}";
            ...
            lblHintCount.Text = $"Segítségek száma: {render.hintCount}";
            ...
            lblUndoCount.Text = $"Visszavonások száma: {undoredoManager.undoClicks}";
            ...
            btnShowExtraSolution.Text = "Megoldás (Számbeíró)";
            ...
            btnPickColor.Text = "Szín kiválasztása";
            ...
            btnExtraGenerate.Text = "Új pálya létrehozása";
