...
namespace Nonogram
{
    public class NonogramGrid
    {
        ...
        public NonogramGrid(Nonogram form)
        {
            this.form = form;
        }
                ...
                switch (shape)
                {
                    case 0: // Kör
                        for (int i = 0; i < 10; i++)
                        {
                            ...
                            if (isColorMode)
                                drawColor = (i == 0) ? Color.Black : Color.FromArgb(rnd.Next(50, 120), rnd.Next(50, 120), rnd.Next(50, 120));
                            else
                                drawColor = Color.Black;

                            Pen p = new Pen(drawColor, 1);
                            int offset = i;
                            g.DrawEllipse(p, w / 4 + offset, h / 4 + offset, w / 2 - 2 * offset, h / 2 - 2 * offset);
                        }
                        break;
                    ...
                    case 1: // Négyszög
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            Pen p = new Pen(drawColor, 1);
                            int offset = i;
                            g.DrawRectangle(p, w / 4 + offset, h / 4 + offset, w / 2 - 2 * offset, h / 2 - 2 * offset);
                        }
                        break;
                    ...
                    case 2: // Háromszög
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            PointF[] tri =
                            {
                        new PointF(w / 2, h / 6 + i),
                        new PointF(w / 6, h * 5 / 6 - i),
                        new PointF(w * 5 / 6, h * 5 / 6 - i)
                    };
                            g.DrawPolygon(p, tri);
                        }
                        break;
                    ...
                    case 3: // Kereszt
                        for (int i = 5; i < w - 5; i++)
                        {
                            ...
                            if (isColorMode)
                                drawColor = (i == 5) ? Color.Black : Color.FromArgb(rnd.Next(50, 120), rnd.Next(50, 120), rnd.Next(50, 120));
                            else
                                drawColor = Color.Black;
                    ...
                    case 4: // Gyémánt
                        for (int i = 0; i < 2; i++)
                        {
                            ...
                            {
                        new PointF(w / 2, 0 + i),
                        new PointF(w - 1 - i, h / 2),
                        new PointF(w / 2, h - 1 - i),
                        new PointF(0 + i, h / 2)
                    };
