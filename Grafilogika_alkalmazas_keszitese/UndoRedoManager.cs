...
namespace Grafilogika_alkalmazas_keszitese
{
    public class UndoRedoManager
    {
        ...
        public void SaveState()
        {
            ...
            Color[,] clone = CloneGrid(); // eredeti rács másolása
            form.undoStack.Push(Tuple.Create(clone, form.wrongCellClicks, form.wrongColorClicks));
        ...
        public void Undo()
        {
            ...
            form.redoStack.Push(Tuple.Create(currentClone, form.wrongCellClicks, form.wrongColorClicks));
        ...
        public void Redo()
        {
            ...
            Color[,] currentClone = CloneGrid();
            form.undoStack.Push(Tuple.Create(currentClone, form.wrongCellClicks, form.wrongColorClicks));
