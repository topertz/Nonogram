...
namespace Grafilogika_alkalmazas_keszitese
{
    public partial class Nonogram : Form
    {
        ...
        public CheckBox chkShowX, chkExtraMode, chkImgColorMode, chkImgBlackWhiteMode;
        ...
        public Nonogram()
        {
            ...
            chkImgColorMode.Visible = true;
            chkImgBlackWhiteMode.Visible = true;
        ...
        private void InitializeCustomComponents()
        {
            ...
            chkImgBlackWhiteMode = new CheckBox();
            chkImgBlackWhiteMode.Text = "Fekete-fehér képbeolvasó mód";
            chkImgBlackWhiteMode.Location = new Point(170, 575); // a Színes mód fölé
            chkImgBlackWhiteMode.AutoSize = true;
            chkImgBlackWhiteMode.CheckedChanged += extraGridManager.ChkBlackWhiteMode_CheckedChanged;
            chkImgBlackWhiteMode.Font = new Font("Arial", 10, FontStyle.Bold);
            this.Controls.Add(chkImgBlackWhiteMode);

            chkImgColorMode = new CheckBox();
            chkImgColorMode.Text = "Színes képbeolvasó mód";
            chkImgColorMode.Location = new Point(170, 600);
            chkImgColorMode.AutoSize = true;
            chkImgColorMode.CheckedChanged += extraGridManager.ChkColorMode_CheckedChanged;
            chkImgColorMode.Font = new Font("Arial", 10, FontStyle.Bold);
            this.Controls.Add(chkImgColorMode);
            ...
            btnBackToHome.Text = "Visszalépés a kezdőoldalra";
            btnBackToHome.Size = new Size(210, 25);
