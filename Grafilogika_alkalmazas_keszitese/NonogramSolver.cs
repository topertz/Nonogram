...
namespace Grafilogika_alkalmazas_keszitese
{
    public class NonogramSolver
    {
        ...
        public NonogramSolver(Nonogram f, NonogramGrid g)
        {
            this.form = f;
            this.grid = g;
            this.rows = grid.row;
            this.cols = grid.col;
            this.rowClues = grid.rowClues;
            this.colClues = grid.colClues;
            this.rowClueColors = grid.rowClueColors;
            this.colClueColors = grid.colClueColors;
            this.isColor = grid.isColor;
            this.nonogramColors = grid.nonogramColors;
        }
