...
namespace Grafilogika_alkalmazas_keszitese
{
    public class GameTimerManager
    {
        ...
        public void BtnTips_Click(object sender, EventArgs e)
        {
            ...
            tips.AppendLine("Amennyiben egy sor vagy oszlop számainak összege + a kötelező szóközök = a sor vagy oszlop hossza, akkor az egész sort vagy oszlopot ki kell tölteni.\n");
