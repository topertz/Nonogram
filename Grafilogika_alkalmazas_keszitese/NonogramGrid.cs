...
namespace Grafilogika_alkalmazas_keszitese
{
    public class NonogramGrid
    {
        ...
        public NonogramGrid(Nonogram f, GameTimerManager g, NonogramRender r, UndoRedoManager u, ExtraGridManager e, NonogramHintEngine h)
        {
            this.form = f;
            this.render = r;
        ...
        public void GridCell_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            // Hintek frissítése (ha Easy fokozaton vagyunk, rögtön mutatja a következőt)
                    ...
                    btn.Paint += (s, e) =>
                    {
                        ...
                        if(render.showHints)
                        {
                            ...
                            if (hintEngine.hintCells.Contains(p))
                            {
                                ...
                                using (Brush br = new SolidBrush(Color.FromArgb(80, hintColor)))
                                {
                                    e.Graphics.FillRectangle(br, b.ClientRectangle);
                                }
                            }
