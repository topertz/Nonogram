...
namespace Grafilogika_alkalmazas_keszitese
{
    public class GameTimerManager
    {
        ...
        public void BtnBackToHome_Click(object sender, EventArgs e)
        {
            ...
            form.groupModes.Location = new Point(140, 530);
            ...
            form.lblHintCount.Text = $"Segítségek száma: {render.hintCount} (max: 0)";
        ...
        public void BtnTips_Click(object sender, EventArgs e)
        {
            ...
            tips.AppendLine("Ha egy sor vagy oszlop számainak összege + a kötelező szóközök = a sor vagy oszlop hossza,");
            tips.AppendLine("az egész sort vagy oszlopot ki lehet tölteni.\n");

            tips.AppendLine("Ha egy szám nagyobb, mint a sor vagy oszlop fele,");
            ...
            tips.AppendLine("és a blokkok között legalább egy üres cella kell legyen (kivéve színes nonogramnál," +
                " ha ugyanaz a szín ismétlődik).\n");
            ...
            tips.AppendLine("X jelek célja: megjelölni azokat a cellákat, amelyek biztosan NEM tartoznak a megoldáshoz.");
            ...
            tips.AppendLine("Mousedrag gyorsítja a játékot, különösen nagyobb rácsoknál.\n");

            // fekete fehér mód
            tips.AppendLine("FEKETE–FEHÉR MÓD\n");
            tips.AppendLine("Bal kattintás: fekete cella lerakása vagy törlése.");
            ...
            tips.AppendLine("X jelek segítik a kizárást és logikai következtetéseket.\n");
            ...
            tips.AppendLine("Különböző színek között nem kötelező üres cella (de lehet).");
            tips.AppendLine("Azonos színű blokkok között legalább egy üres cella kell, hogy legyen, különben egy blokk lenne.");
            tips.AppendLine("X jelek színes módban is használhatók a kizáráshoz, " +
                "de vigyázat itt nem mindig egyértelmű a kizárás.\n");

            tips.AppendLine("Általános tipp: mindig ellenőrizd a sorok és oszlopok számait " +
                "és használd a logikát a hibák elkerülésére.\n");
        ...
        private void SetTimeByDifficulty()
        {
            if (grid.isColor) // Színes mód
            {
                ...
                {
                    case 0: remainingSeconds = 9 * 60; break;
                    case 1: remainingSeconds = 21 * 60; break;
                    case 2: remainingSeconds = 38 * 60; break;
                    default: remainingSeconds = 9 * 60; break;
                }
            }
