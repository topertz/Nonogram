...
namespace Grafilogika_alkalmazas_keszitese
{
    public class GameTimerManager
    {
        ...
        {
            string difficulty = form.cmbDifficulty.SelectedItem?.ToString();
            string mode = form.cmbMode.SelectedItem?.ToString();
            ...
            if (mode == "Fekete-fehér")
            {
                switch (difficulty)
                {
                    ...
                    case "Közepes":
                        text =
                            "Közepes szint – Fekete-fehér mód\n" +
