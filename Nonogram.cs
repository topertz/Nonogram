...
namespace Grafilogika_alkalmazas_keszitese
{
    public partial class Nonogram : Form
    {
        ...
        public Button btnSmartAI, btnBackToHome, btnExtraGenerate;
        public PictureBox picPreview, picSolutionPreview;
        public CheckBox chkShowX;
        public RadioButton rbNumberEntryMode, rbImgColorMode, rbImgBlackWhiteMode;
        ...
        public Label lblTimer, lblUndoCount;
        public GroupBox groupModes;
        ...
        public Nonogram()
        {
            ...
            extraGridManager = new ExtraGridManager(this, grid, render);
            render = new NonogramRender(this, null, null, undoredoManager, leaderBoardManager, extraGridManager);
            ...
            render.SetExtraGridManager(extraGridManager);
            ...
            extraGridManager.SetRender(render);
            ...
            rbNumberEntryMode.Visible = true;
            rbImgColorMode.Visible = true;
            rbImgBlackWhiteMode.Visible = true;
            ...
            btnExtraGenerate.Visible = false;
            ...
            toolTip = new ToolTip
            {
                AutoPopDelay = 8000,    // How long the bubbles will remain visible (8 sec)
                InitialDelay = 400,     // Wait before displaying if you hold the mouse (0.4 sec)
                ReshowDelay = 200,      // Wait when moving the mouse from one element to another (0.2 sec)
                ShowAlways = true,      // Visible even if the window is not in focus
                IsBalloon = true        // Use of modern, rounded speech bubbles
            };
        ...
        private void InitializeCustomComponents()
        {
           ...
           // Solve button
            ...
            btnSmartAI.Text = "AI";
            btnSmartAI.Location = new Point(405, 700);
            ...
            chkShowX.Text = "Displaying empty cells";
            ...
            lblExtra = new Label();
            lblExtra.Text = "Extra mods";
            lblExtra.Location = new Point(20, 180);
            ...
            groupModes.Text = "";
            groupModes.Location = new Point(20, 200);
            groupModes.Size = new Size(260, 100);
            groupModes.BackColor = Color.LightYellow;
            groupModes.Paint += (s, e) =>
            {
                // Thicker frame
                int thickness = 3;
                Color borderColor = Color.Green;

                // Define a Rectangle for the frame
                Rectangle rect = new Rectangle(0, 0, groupModes.Width - 1, groupModes.Height - 1);
            ...
            this.Controls.Add(groupModes);

            rbNumberEntryMode = new RadioButton();
            rbNumberEntryMode.Text = "Numerical mod";
            rbNumberEntryMode.Location = new Point(10, 20);
            rbNumberEntryMode.AutoSize = true;
            rbNumberEntryMode.CheckedChanged += extraGridManager.RbNumberEntryMode_CheckedChanged;
            rbNumberEntryMode.Font = new Font("Arial", 10, FontStyle.Bold);
            ...
            rbImgBlackWhiteMode.Font = new Font("Arial", 10, FontStyle.Bold);
            this.Controls.Add(rbImgBlackWhiteMode);

            rbImgColorMode = new RadioButton();
            rbImgColorMode.Text = "Color image scanning mode";
            rbImgColorMode.Location = new Point(10, 60);
            rbImgColorMode.AutoSize = true;
            rbImgColorMode.CheckedChanged += extraGridManager.RbImgColorMode_CheckedChanged;
            rbImgColorMode.Font = new Font("Arial", 10, FontStyle.Bold);
            this.Controls.Add(rbImgColorMode);
            groupModes.Controls.Add(rbNumberEntryMode);
            groupModes.Controls.Add(rbImgBlackWhiteMode);
            groupModes.Controls.Add(rbImgColorMode);
            ...
            btnUndo.BackColor = Color.Orange;
            ...
            btnRedo.BackColor = Color.Orange;
            ...
            // Random Nonogram generation button
            btnGenerateRandom = new Button();
            btnGenerateRandom.Text = "START";
            btnGenerateRandom.Location = new Point(20, 140);
            ...
            cmbDifficulty.Location = new Point(20, 50);
            ...
            // Game mode selector (black-and-white / color)
            cmbMode = new ComboBox();
            cmbMode.Items.AddRange(new string[] { "Black and white", "Colored" });
            cmbMode.SelectedIndex = 0;
            cmbMode.DropDownStyle = ComboBoxStyle.DropDownList;
            cmbMode.Location = new Point(200, 53);
            cmbMode.Width = 150;
            ...
            // Incorrect click count Label
            lblWrongCellClicks = new Label();
            lblWrongCellClicks.Text = $"Number of incorrect clicks: {grid.wrongCellClicks}";
            lblWrongCellClicks.Location = new Point(20, 130);
            ...
            // Incorrect color count Label
            lblWrongColorClicks = new Label();
            lblWrongColorClicks.Text = $"Incorrect number of colors: {grid.wrongColorClicks}";
            lblWrongColorClicks.Location = new Point(20, 150);
            ...
            lblHintCount.Text = $"Number of hints: {render.hintCount}";
            lblHintCount.Location = new Point(20, 170);
            ...
            lblUndoCount.Text = $"Number of withdrawals: {undoredoManager.undoClicks}";
            lblUndoCount.Location = new Point(20, 190);
            lblUndoCount.AutoSize = true;
            lblUndoCount.Font = new Font("Arial", 10, FontStyle.Bold);
            this.Controls.Add(lblUndoCount);

            btnLeaderboard = new Button();
            btnLeaderboard.Text = "Ranking list";
            btnLeaderboard.Location = new Point(140, 140);
            ...
            btnSelectImage.Text = "Image selection";
            ...
            btnShowExtraSolution.Text = "Solution (Numerical)";
            btnShowExtraSolution.Size = new Size(200, 25);
            btnShowExtraSolution.Location = new Point(460, 700);
            ...
            btnPickColor.Text = "Color selection";
            btnPickColor.Size = new Size(140, 25);
            btnPickColor.Location = new Point(690, 700);
            ...
            btnResetExtraGrid.Location = new Point(860, 700);
            ...
            btnSaveClues.Text = "Save numbers";
            btnSaveClues.Size = new Size(140, 25);
            btnSaveClues.Location = new Point(500, 740);
            btnSaveClues.Click += extraGridManager.BtnSaveClues_Click;
            btnSaveClues.FlatStyle = FlatStyle.Flat;
            btnSaveClues.BackColor = Color.Orange;
            btnSaveClues.ForeColor = Color.Black;
            ...
            btnLoadClues.Text = "Load numbers";
            btnLoadClues.Size = new Size(140, 25);
            btnLoadClues.Location = new Point(670, 740);
            btnLoadClues.Click += extraGridManager.BtnLoadClues_Click;
            btnLoadClues.FlatStyle = FlatStyle.Flat;
            btnLoadClues.BackColor = Color.Orange;
            btnLoadClues.ForeColor = Color.Black;
            ...
            btnTips = new Button();
            btnTips.Text = "Tips!!!";
            btnTips.Location = new Point(150, 10);
            ...
            btnRestart.Text = "Generating a new puzzle";
            ...
            btnBackToHome.Text = "Main menu";
            btnBackToHome.Size = new Size(125, 25);
            btnBackToHome.Location = new Point(720, 650);
            btnBackToHome.FlatStyle = FlatStyle.Flat;
            btnBackToHome.BackColor = Color.LightCoral;
            btnBackToHome.FlatAppearance.BorderSize = 0;
            btnBackToHome.Font = new Font("Arial", 10, FontStyle.Bold);
            btnBackToHome.Click += gameTimerManager.BtnBackToHome_Click;
            this.Controls.Add(btnBackToHome);

            btnExtraGenerate = new Button();
            btnExtraGenerate.Text = "Creating a new path";
            btnExtraGenerate.Size = new Size(180, 25);
            btnExtraGenerate.Location = new Point(110, 400);
            btnExtraGenerate.FlatStyle = FlatStyle.Flat;
            btnExtraGenerate.BackColor = Color.MediumSeaGreen;
            btnExtraGenerate.FlatAppearance.BorderSize = 0;
            btnExtraGenerate.Font = new Font("Arial", 10, FontStyle.Bold);
            btnExtraGenerate.Click += extraGridManager.BtnGenerateExtraGrid_Click;
            this.Controls.Add(btnExtraGenerate);
            ...
            txtUsername.Location = new Point(145, 95);
