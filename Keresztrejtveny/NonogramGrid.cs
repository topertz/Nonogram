...
namespace Nonogram
{
    public class NonogramGrid
    {
        ...
        public void GenerateRandomNonogram(int gridLeft, int gridTop)
        {
            int w = 10;
            int h = 10;
            form.row = h;
        ...
        private void GenerateClues()
        {
            ...
            for (int i = 0; i < form.row; i++)
            {
                ...
                while (j < form.col)
                {
                    ...
                    // 1. A táblán belül vagyunk
                    // 2. A cella ki van töltve (BW == 1)
                    // 3. ÉS (színes mód esetén) a színe megegyezik a blokk kezdő színével
