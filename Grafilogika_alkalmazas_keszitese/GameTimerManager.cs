...
namespace Grafilogika_alkalmazas_keszitese
{
    public class GameTimerManager
    {
        ...
        public void BtnTips_Click(object sender, EventArgs e)
        {
            ...
            tips.AppendLine("Különböző színek között nem kell üres cella.");
            tips.AppendLine("Azonos színű blokkok között legalább egy üres cella kell, különben egy blokk lenne.");
