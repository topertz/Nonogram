...
namespace Grafilogika_alkalmazas_keszitese
{
    public class GameTimerManager
    {
        ...
        public void BtnTips_Click(object sender, EventArgs e)
        {
            ...
            tips.AppendLine("Amennyiben egy sor vagy oszlop számainak összege + a kötelező szóközök = a sor vagy oszlop hossza,");
            tips.AppendLine("akkor az egész sort vagy oszlopot ki kell tölteni.\n");

            tips.AppendLine("Amennyiben egy szám nagyobb, mint a sor vagy oszlop fele,");
            tips.AppendLine("akkor a középső cellák biztosan kitöltöttek.\n");
            ...
            tips.AppendLine("Az X jelek színes módban is használhatók a kizáráshoz, " +
