...
namespace Grafilogika_alkalmazas_keszitese
{
    public class ExtraGridManager
    {
        ...
        private void SetMode()
        {
            ...
            form.chkImgColorMode.Visible = true;
            form.chkImgBlackWhiteMode.Visible = true;
            ...
            else if (form.chkImgBlackWhiteMode.Checked)
            {
            ...
            else if (form.chkImgColorMode.Checked)
            {
                form.btnSelectImage.Visible = true;
                form.picPreview.Visible = true;
                form.chkShowX.Visible = true;
            ...
            for (int rowIndex = 0; rowIndex < row; rowIndex++)
            {
                for (int colIndex = 0; colIndex < col; colIndex++)
                {
                    ...
                    else
                    {
                        ...
                        extraButtons[rowIndex, colIndex].Text = "X";
