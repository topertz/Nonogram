...
namespace Grafilogika_alkalmazas_keszitese
{
    public class NonogramGrid
    {
        ...
        private NonogramSmartAI nonogramSmartAI;

        public NonogramGrid(Nonogram f, GameTimerManager g, NonogramRender r, UndoRedoManager u, ExtraGridManager e, NonogramSmartAI n)
        {
            this.form = f;
            this.render = r;
        ...
        public async void BtnSmartAIGuide_Click(object sender, EventArgs e)
        {
            ...
            bool solved = await nonogramSmartAI.SolveWithSpeculation(); // Új metódus, ami backtrackinget is használ
