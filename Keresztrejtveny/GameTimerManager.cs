    ...
    public class GameTimerManager
    {
        ...
        public void SetMaxWrongClicksByDifficulty()
        {
            if (form.isColor) // Színes mód
            {
                ...
                {
                    case 0: // Könnyű
                        form.maxWrongCellClicks = 20;
                        form.maxWrongColorClicks = 25;
                        break;
                    case 1: // Közepes
                        form.maxWrongCellClicks = 75;
                        form.maxWrongColorClicks = 80;
                        break;
                    case 2: // Nehéz
                        form.maxWrongCellClicks = 120;
                        form.maxWrongColorClicks = 125;
                        break;
                    default:
                        form.maxWrongCellClicks = 20;
                        form.maxWrongColorClicks = 25;
            ...
            else // Fekete-fehér mód
            {
                switch (form.cmbDifficulty.SelectedIndex)
                {
                    case 0: // Könnyű
                        ...
                        break;
                    case 1: // Közepes
                        form.maxWrongCellClicks = 70;
                        form.maxWrongColorClicks = 80;
                        break;
                    case 2: // Nehéz
                        form.maxWrongCellClicks = 115;
                        form.maxWrongColorClicks = 120;
                        break;
        ...
        public void SetMaxHintsByDifficulty()
        {
            if (form.isColor) // Színes mód
            {
                ...
                {
                    case 0: // Könnyű
                        form.maxHintCount = 20;
                        break;
                    case 1: // Közepes
                        form.maxHintCount = 75;
                        break;
                    case 2: // Nehéz
                        form.maxHintCount = 120;
                        break;
                    default:
                        form.maxHintCount = 20;
                        break;
            ...
            else // Fekete-fehér mód
            {
                ...
                {
                    case 0: // Könnyű
                        form.maxHintCount = 15;
                        break;
                    case 1: // Közepes
                        form.maxHintCount = 70;
                        break;
                    case 2: // Nehéz
                        form.maxHintCount = 115;
                        break;
                    default:
                        form.maxHintCount = 15;
                        break;
